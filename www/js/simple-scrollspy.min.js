          ...
          o.ScrollSpy = class {
            ...
            attachEventListeners() {
              if (
                ...
                this.options.smoothScroll && this.menuList)
              ) {
                this.menuList
            ...
            onScroll() {
              ...
              if (t) {
                const o = this.getMenuItemBySection(t);
                o &&
                  (this.removeCurrentActive({ ignore: o }), this.setActive(o));
              }
            }
            scrollTo(t) {
              const o =
